...
export const schools = [
  ...
  },
  {
    ...
    gpaRequirement: '>7.5',
    top2Group: true,
    description: 'Một trong 3 trường top (SKY), nổi tiếng về ngành Y và Kinh tế. Môi trường học tập quốc tế. Được học sinh Việt Nam ưa thích với tỉ lệ visa cao.',
  ...
  },
  {
    ...
    majors: ['Y tế', 'Kỹ thuật', 'Kinh tế', 'Khoa học', 'Nông nghiệp'],
    topMajors: ['Y tế', 'Kỹ thuật', 'Nông nghiệp'],
    scholarship: '30-100%',
    dormitory: 'Có',
    dormitoryCost: '20-30 triệu/năm',
    language: 'TOPIK 2-4',
    description: 'Trường đại học quốc gia hàng đầu tại khu vực Gyeongsang. Chi phí thấp, chất lượng giáo dục tốt. Nổi tiếng về ngành Y tế và Nông nghiệp.',
  ...
  },
  {
    ...
    type: 'Tư thục',
    tuition: 1450000,
    tuitionRange: '1.45 triệu won/kỳ',
    majors: ['Y tế', 'Nhân văn', 'Kinh tế'],
    topMajors: ['Y tế', 'Nhân văn'],
    scholarship: '30-60%',
    dormitory: 'Có',
    ...
    gpaRequirement: '>7.0',
    top2Group: true,
    description: 'Trường đại học uy tín tại Seoul. Mạnh về Y tế và Nhân văn. Được học sinh Việt Nam ưa thích với tỉ lệ visa cao.',
  ...
  },
  {
    ...
    type: 'Tư thục',
    tuition: 1650000,
    tuitionRange: '1.65 triệu won/kỳ',
    majors: ['Nghệ thuật', 'Nhân văn', 'Kinh tế'],
    topMajors: ['Nghệ thuật', 'Nhân văn'],
    scholarship: '30-60%',
    dormitory: 'Có',
    dormitoryCost: '600.000 won/kỳ (phòng 4 người)',
    language: 'TOPIK 3-4',
    gpaRequirement: '>7.2 (Miền Trung >8.0)',
    top2Group: true,
    description: 'Trường đại học uy tín tại Seoul. Mạnh về Nghệ thuật và Nhân văn. Được học sinh Việt Nam ưa thích với tỉ lệ visa cao.',
  ...
  },
  {
    ...
    gpaRequirement: '>7.5',
    top2Group: true,
    description: 'Trường đại học uy tín tại Seoul. Mạnh về Kỹ thuật và Kinh tế. Được học sinh Việt Nam ưa thích với tỉ lệ visa cao.',
  ...
  },
  {
    ...
    type: 'Tư thục',
    tuition: 1200000,
    tuitionRange: '1.2 triệu won/kỳ',
    majors: ['Y tế', 'Kỹ thuật', 'Kinh tế'],
    topMajors: ['Y tế', 'Kỹ thuật'],
    scholarship: '30-70%',
    dormitory: 'Có',
    dormitoryCost: '756.000 won/3 tháng',
    language: 'TOPIK 3-4',
    gpaRequirement: '>6.5',
    top2Group: true,
    restrictions: 'Hạn chế: Nghệ An - Hà Tĩnh',
    description: 'Trường đại học uy tín tại Busan. Mạnh về Y tế và Kỹ thuật. Được học sinh Việt Nam ưa thích với tỉ lệ visa cao.',
  ...
  {
    id: 51,
    name: 'Đại học Khoa học Kỹ thuật Busan (BIST)',
    nameKr: '부산과학기술대학교',
    city: 'Busan',
    ranking: 51,
    rankingWorld: 1001,
    type: 'Tư thục',
    tuition: 1100000,
    tuitionRange: '1.1 triệu won/kỳ',
    majors: ['Kỹ thuật', 'Khoa học', 'Công nghệ'],
    topMajors: ['Kỹ thuật', 'Khoa học'],
    scholarship: '30-70%',
    dormitory: 'Có',
    dormitoryCost: '20-30 triệu/năm',
    language: 'TOPIK 2-3',
    gpaRequirement: '>6.5 (Nhận GDTX)',
    top2Group: true,
    description: 'Trường đại học khoa học kỹ thuật tại Busan. Chi phí thấp, nhận cả học sinh GDTX. Được học sinh Việt Nam ưa thích với tỉ lệ visa cao.',
    website: 'https://www.bist.ac.kr',
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRid577NB65T5ARkXDDnqhMOQ7EfY40Cs2tsg&s'
  },
  {
    id: 52,
    ...
    type: 'Tư thục',
    tuition: 2800000,
    tuitionRange: '2.8 triệu won/6 tháng',
    majors: ['Kinh tế', 'Kỹ thuật', 'Nhân văn', 'Nghệ thuật'],
    topMajors: ['Kinh tế', 'Kỹ thuật'],
    scholarship: '30-70%',
    dormitory: 'Có',
    dormitoryCost: '900.000 won/6 tháng',
    language: 'TOPIK 2-4',
    gpaRequirement: '>7.0 (Miền Trung >8.0)',
    top2Group: true,
    description: 'Trường đại học uy tín tại Seoul. Được học sinh Việt Nam ưa thích với tỉ lệ visa cao.',
    website: 'https://www.kyonggi.ac.kr',
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSwoioZAUwy9SRBAoi05wRo2UX3YdFY41Mr3g&s'
  },
  {
    id: 53,
    name: 'Đại học Seoul Tech',
    nameKr: '서울과학기술대학교',
    city: 'Seoul',
    ranking: 53,
    rankingWorld: 1001,
    type: 'Công lập',
    tuition: 1500000,
    tuitionRange: '1.5 triệu won/kỳ',
    majors: ['Kỹ thuật', 'Công nghệ', 'Khoa học', 'Kiến trúc'],
    topMajors: ['Kỹ thuật', 'Công nghệ'],
    scholarship: '30-100%',
    dormitory: 'Có',
    dormitoryCost: '25-40 triệu/năm',
    language: 'TOPIK 2-4',
    gpaRequirement: '>7.0',
    top2Group: true,
    description: 'Trường đại học công lập về khoa học kỹ thuật tại Seoul. Chi phí hợp lý, chất lượng tốt. Được học sinh Việt Nam ưa thích với tỉ lệ visa cao.',
  ...
  },
  {
    ...
    scholarship: '30-70%',
    dormitory: 'Có',
    dormitoryCost: '600.000 won/6 tháng',
    language: 'TOPIK 2-3',
    gpaRequirement: '>6.5',
    top2Group: true,
    description: 'Trường đại học uy tín tại Gimcheon. Chi phí rất thấp, nhiều học bổng. Được học sinh Việt Nam ưa thích với tỉ lệ visa cao.',
  ...
  },
  {
    ...
    type: 'Tư thục',
    tuition: 1300000,
    tuitionRange: '1.3 triệu won/kỳ',
    majors: ['Nhân văn', 'Kinh tế', 'Nghệ thuật'],
    topMajors: ['Nhân văn', 'Kinh tế'],
    scholarship: '30-70%',
    dormitory: 'Có',
    dormitoryCost: '22-35 triệu/năm',
    ...
    gpaRequirement: '>6.5',
    top2Group: true,
    description: 'Trường đại học uy tín tại Daejeon. Chi phí hợp lý, nhiều học bổng. Được học sinh Việt Nam ưa thích với tỉ lệ visa cao.',
    website: 'https://www.pcu.ac.kr',
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSZmic8KMCUw-I7x5okebgrwkKP769GtB4r8Q&s'
  },
  {
    id: 56,
    name: 'Đại học Daekyung',
    nameKr: '대경대학교',
    city: 'Daegu',
    ranking: 56,
    rankingWorld: 1001,
    type: 'Tư thục',
    tuition: 2000000,
    tuitionRange: '2.0-3.0 triệu won/kỳ',
    majors: ['Kỹ thuật', 'Kinh tế', 'Y tế', 'Nghệ thuật'],
    topMajors: ['Kỹ thuật', 'Kinh tế'],
    scholarship: '30-70%',
    dormitory: 'Có',
    dormitoryCost: '20-30 triệu/năm',
    language: 'TOPIK 2-3',
    description: 'Trường đại học uy tín tại Daegu. Chi phí hợp lý, nhiều học bổng.',
  ...
  },
  {
    ...
    dormitoryCost: '21-32 triệu/năm',
    language: 'TOPIK 2-3',
    description: 'Trường đại học uy tín tại Daegu. Mạnh về Kinh tế và Kỹ thuật.',
  ...
  },
  {
    ...
    tuition: 1900000,
    tuitionRange: '1.9-2.9 triệu won/kỳ',
    majors: ['Nhân văn', 'Kinh tế', 'Y tế', 'Nghệ thuật'],
    topMajors: ['Nhân văn', 'Kinh tế'],
    scholarship: '30-70%',
    dormitory: 'Có',
    dormitoryCost: '19-29 triệu/năm',
    language: 'TOPIK 2-3',
    description: 'Trường đại học uy tín tại Gyeongsan. Chi phí thấp, mạnh về Nhân văn.',
    website: 'https://www.daeshin.ac.kr',
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSsccHbueKuw5orHR9tKgcfi3oDZpglJjsc4Q&s'
  },
  {
    id: 59,
    name: 'Đại học Daegu Hanny (Đại học Y học Cổ truyền Hàn Quốc Daegu)',
    nameKr: '대구한의대학교',
    city: 'Daegu',
    ranking: 59,
    rankingWorld: 1001,
    ...
    majors: ['Y tế', 'Y học cổ truyền Hàn Quốc', 'Dược', 'Y tế công cộng'],
    topMajors: ['Y học cổ truyền Hàn Quốc', 'Y tế'],
    scholarship: '30-70%',
    dormitory: 'Có',
    dormitoryCost: '26-40 triệu/năm',
    language: 'TOPIK 3-4',
    description: 'Trường đại học chuyên về Y học cổ truyền Hàn Quốc (Hanny) tại Daegu. Đào tạo độc đáo về y học phương Đông.',
  ...
  },
  {
    ...
    tuition: 1800000,
    tuitionRange: '1.8-2.7 triệu won/kỳ',
    majors: ['Kỹ thuật', 'Kinh tế', 'Công nghệ', 'Nhân văn'],
    topMajors: ['Kỹ thuật', 'Công nghệ'],
    scholarship: '30-70%',
    dormitory: 'Có',
    dormitoryCost: '18-27 triệu/năm',
    language: 'TOPIK 2-3',
    description: 'Trường đại học uy tín tại Ansan. Chi phí rất thấp, mạnh về Kỹ thuật và Công nghệ.',
    website: 'https://www.ansan.ac.kr',
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSsccHbueKuw5orHR9tKgcfi3oDZpglJjsc4Q&s'
  },
  {
    id: 61,
    name: 'Đại học Khoa học & Công nghệ Gyeonggi',
    nameKr: '경기과학기술대학교',
    city: 'Siheung',
    ranking: 61,
    rankingWorld: 1001,
    ...
    tuition: 2000000,
    tuitionRange: '2.0-3.0 triệu won/kỳ',
    majors: ['Kỹ thuật', 'Công nghệ', 'Khoa học', 'Công nghệ thông tin'],
    topMajors: ['Kỹ thuật', 'Công nghệ thông tin'],
    scholarship: '30-70%',
    dormitory: 'Có',
    dormitoryCost: '20-30 triệu/năm',
    language: 'TOPIK 2-3',
    description: 'Trường đại học chuyên về khoa học và công nghệ tại Gyeonggi. Mạnh về Kỹ thuật và Công nghệ thông tin.',
    website: 'https://www.gtech.ac.kr',
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRid577NB65T5ARkXDDnqhMOQ7EfY40Cs2tsg&s'
  },
  {
    id: 62,
    ...
    topMajors: ['Kinh tế', 'Nhân văn'],
    scholarship: '30-70%',
    dormitory: 'Có',
    dormitoryCost: '17-26 triệu/năm',
    language: 'TOPIK 2-3',
    description: 'Trường đại học uy tín tại Gyeonggi. Chi phí rất thấp, nhiều học bổng.',
  ...
  },
  {
    ...
    dormitoryCost: '19-29 triệu/năm',
    language: 'TOPIK 2-3',
    description: 'Trường đại học uy tín tại Gumi - thành phố công nghiệp lớn. Chi phí thấp, mạnh về Kỹ thuật và Công nghệ.',
    website: 'https://www.gumi.ac.kr',
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRid577NB65T5ARkXDDnqhMOQ7EfY40Cs2tsg&s'
  },
  {
    id: 64,
    name: 'Đại học Catholic Kwandong',
    nameKr: '가톨릭관동대학교',
    city: 'Gangneung',
    ranking: 64,
    rankingWorld: 1001,
    ...
    tuition: 2500000,
    tuitionRange: '2.5-3.8 triệu won/kỳ',
    majors: ['Y tế', 'Nhân văn', 'Kinh tế', 'Nghệ thuật'],
    topMajors: ['Y tế', 'Nhân văn'],
    scholarship: '30-70%',
    dormitory: 'Có',
    dormitoryCost: '24-36 triệu/năm',
    language: 'TOPIK 2-4',
    description: 'Trường đại học Công giáo uy tín tại Gangneung, bờ biển phía đông. Mạnh về Y tế và Nhân văn. Môi trường học tập đẹp gần biển.',
